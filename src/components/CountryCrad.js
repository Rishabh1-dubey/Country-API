...
const CountryCrad = ({ name, flag, capital, population }) => {
  ...
  return (
    <div>
      <div className="border border-black w-[300px] h-[300px]  rounded-xl bg-gray-100 shadow-xl hover:scale-105 cursor-pointer transition ease-in-out delay-50 hover:shadow-green-500">{

        <img
        className=" w-auto p-2 m-2 mx-6 rounded-2xl   h-[200px]"
